...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Deudor', fields ['CURP']
        db.create_unique(u'deudores_deudor', ['CURP'])


    def backwards(self, orm):
        # Removing unique constraint on 'Deudor', fields ['CURP']
        db.delete_unique(u'deudores_deudor', ['CURP'])
    ...
    models = {
        ...
        u'deudores.deudor': {
            'CURP': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '12', 'blank': 'True'}),
