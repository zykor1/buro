...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Deudor.estado'
        db.delete_column(u'deudores_deudor', 'estado')


        # Changing field 'Deudor.fecha_ingreso'
        db.alter_column(u'deudores_deudor', 'fecha_ingreso', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 6, 12, 0, 0)))

    def backwards(self, orm):
        # Adding field 'Deudor.estado'
        db.add_column(u'deudores_deudor', 'estado',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)


        # Changing field 'Deudor.fecha_ingreso'
        db.alter_column(u'deudores_deudor', 'fecha_ingreso', self.gf('django.db.models.fields.DateField')(null=True))
