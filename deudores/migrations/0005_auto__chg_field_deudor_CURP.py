...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'deudores_deudor', 'CURP', self.gf('django.db.models.fields.CharField')(max_length=18, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Deudor.CURP'
        db.alter_column(u'deudores_deudor', 'CURP', self.gf('django.db.models.fields.CharField')(default='', max_length=18, unique=True))
