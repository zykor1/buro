...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deudor.CURP'
        db.alter_column(u'deudores_deudor', 'CURP', self.gf('django.db.models.fields.CharField')(unique=True, max_length=18))

    def backwards(self, orm):

        # Changing field 'Deudor.CURP'
        db.alter_column(u'deudores_deudor', 'CURP', self.gf('django.db.models.fields.CharField')(max_length=12, unique=True))
    ...
    models = {
        ...
        u'deudores.deudor': {
            'CURP': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '18', 'blank': 'True'}),
